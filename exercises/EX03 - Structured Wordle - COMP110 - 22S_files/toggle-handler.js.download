function hideshow() {
    ...
    if (doc.style.display === "none") {
      ...
      contentDoc.className = "content col-xl-9 col-lg-9 order-2 order-lg-1"; 
      boxDoc.className = "toc col-xl-3 col-lg-3 order-1 order-lg-2"; 
      arrow.src = "/static/components/Itinerary/arrow-right.png";
      button.childNodes[0].nodeValue = "Overview";
    } else {
      doc.style.display = "none";
      contentDoc.className = "content col-xl-11 col-lg-9 order-2 order-lg-1"; 
      boxDoc.className = "toc col-xl-1 col-lg-3 order-1 order-lg-2"; 
      arrow.src = "/static/components/Itinerary/arrow-left.png";
